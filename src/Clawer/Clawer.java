...
String tempString =MD5.GetMD5("test".getBytes());
	...
	public void Clawing(String[] seeds)
	{
		...
		while(!LinkedQueue.IsUnvisiedEmpty()&&LinkedQueue.GetVisitedNumber()<1000)
		{
			...
			Set<String> linksSet=HTMLParserTool.ExtractLinks(urlString, filter);
...
////			UrlEncodedFormEntity entity =new UrlEncodedFormEntity(paras,Consts.UTF_8);
...
//			        outputStream=new FileOutputStream("/home/oxie/Downloads/Clawer/"+fileNameString);
//			        int tempByte=-1;
